...
Команды для тестирования и сборки проекта на Go см. в файле .\Task_4\README.md

В программе на Go, имитирующей работу реестра домашних животных, реализован следующий функционал:

- Навигация через меню
    - Вывести реестр животных
    - Завести новое животное
    - Определять класс животного
    - Вывести список команд, которые выполняет животное
    - Обучить животное новым командам

В программе создан класс Счетчик, у которого есть метод add(), увеличивающий̆  значение внутренней int переменной на 1 при добавлении нового животного в реестр.
- Для объекта Счетчик реализован аналог механизма try-with-resources.
- При работе с объектом вне метода add() и/или если объект открыт вызвывается исключение.
- Перед вызовом метода add() происходит дополнительная проверка, что при заведения животного заполнены все поля.

<br><br>

## Команды Python

Команды запуска проекта на Python см. в файле .\Task_4_Python\README.md
- Проект не завершен
